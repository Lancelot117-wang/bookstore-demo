...
public class LMONKEY_PRODUCT {
	...
	public LMONKEY_PRODUCT(int pRODUCT_ID, String pRODUCT_NAME, String pRODUCT_DESCRIPTION, int pRODUCT_PRICE,
			int pRODUCT_STOCK, int pRODUCT_PID, int pRODUCT_CID, String pRODUCT_FILENAME) {
		super();
