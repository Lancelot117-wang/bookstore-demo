...
<div class="cart mt"><!-----------------logo------------------->
    ...
    <div class="table wrapper">
        ...
        <div class="th">
            <div class="pro clearfix"><label class="fl"><input name="ck" type="checkbox" value="${c.CART_ID }"/><span></span></label>
            <a class="fl" href="selectproductview?id=${c.CART_P_ID }">
                <dl class="clearfix">
                    <dt class="fl"><img width="120" height="120"  src="images/product/${c.CART_P_FILENAME }"></dt>
                    <dd class="fl">
                    	<p>${c.CART_P_NAME }</p>
                    </dd>
                </dl>
            ...
            <div class="number"><p class="num clearfix"><img class="fl sub" src="img/temp/sub.jpg">
            <span datasrc="${c.CART_ID }" class="fl">${c.CART_QUANTITY }</span><img class="fl add" src="img/temp/add.jpg"></p></div>
            <div class="price sAll">$${c.CART_P_PRICE*c.CART_QUANTITY }.00</div>
            <div class="price"><a class="del" datasrc="${c.CART_ID }" href="#2">删除</a></div>
        </div>
