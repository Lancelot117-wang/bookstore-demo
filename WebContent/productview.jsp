...
<div class="address">
    ...
    <a href="/MonkeyShop/selectproductlist?cid=${cate.CATE_ID }">${cate.CATE_NAME }</a><span>/</span>
...
<div class="introMsg wrapper clearfix">
    ...
    <div class="msgR fr" style="width:200px;"><h4>为你推荐</h4>
        <div class="seeList">
        <c:forEach var="cp" items="${productlist }">
        <a href="selectproductview?id=${cp.PRODUCT_ID }">
            <dl>
                <dt><img src="images/product/${cp.PRODUCT_FILENAME }" style="width:180px;"></dt>
            ...
            <div class="likeList clearfix">
                <div>
                	<c:forEach var="lp" items="${lastlist }">
            			...
            			<dl>
                			<dt><img src="images/product/${lp.PRODUCT_FILENAME }" style="width:180px;"></dt>
